...
![Aetheria system context: clients, TanStack Start server, Supabase and providers](diagrams/hld-system-context.png)
...
![Visit stage machine: booked, arrived, waiting, in treatment, aftercare, complete, no show](diagrams/visit-stage-machine.png)
