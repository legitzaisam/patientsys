  ...
  public: {
    Tables: {
      ...
      ex_team_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "ex_team_members_clinic_id_fkey";
            columns: ["clinic_id"];
            isOneToOne: false;
            referencedRelation: "clinics";
            referencedColumns: ["id"];
      ...
      staff_chat_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_chat_messages_clinic_id_fkey";
            columns: ["clinic_id"];
            isOneToOne: false;
            referencedRelation: "clinics";
            referencedColumns: ["id"];
      ...
      staff_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_conversations_clinic_id_fkey";
            columns: ["clinic_id"];
            isOneToOne: false;
            referencedRelation: "clinics";
            referencedColumns: ["id"];
      ...
      treatment_colour_themes: {
        ...
        Relationships: [
          {
            foreignKeyName: "treatment_colour_themes_clinic_id_fkey";
            columns: ["clinic_id"];
            isOneToOne: false;
            referencedRelation: "clinics";
            referencedColumns: ["id"];
      ...
      treatment_colours: {
        ...
        Relationships: [
          {
            foreignKeyName: "treatment_colours_clinic_id_fkey";
            columns: ["clinic_id"];
            isOneToOne: false;
            referencedRelation: "clinics";
            referencedColumns: ["id"];
