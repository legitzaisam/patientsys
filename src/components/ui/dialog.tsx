...
/** Toasts sit outside the dialog; don't treat them as "click outside to close". */
...
>(({
  ...
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-2 top-2 rounded-full p-2 opacity-70 ring-offset-background cursor-pointer transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
        <X className="h-4 w-4" />
