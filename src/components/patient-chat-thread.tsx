...
/**
 * The clinic ↔ patient conversation body: day-grouped bubbles + composer.
 * Shared by the docked record-page panel and the floating chat window, so both
 * render the exact same thread.
 */
export function PatientChatThread({
  patientId,
  patientName,
  messages,
  as,
